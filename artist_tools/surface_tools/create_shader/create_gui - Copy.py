...
def createGUI():
	...
	# Create and position the apply shader buttons
	...
	#cmds.text('\t')
	cmds.button(l='Create shader', h=30, c=casd.createAiStandard)
	cmds.text('\t')
